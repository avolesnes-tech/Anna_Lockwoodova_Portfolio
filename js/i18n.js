...
(function () {
  ...
  const translations = {
    sk: {
      ...
      'projects.callout.cta': 'Chcete takýto web?',
      ...
      'skills.col1.li6': 'Prístupné pre každého — aj pre používateľov s hendikepom',

      'skills.col2.title': 'WordPress & CMS',
      'skills.col2.li1': 'WordPress s Elementorom — na mieru',
      'skills.col2.li2': 'Vlastné bloky a komponenty navyše',
      'skills.col2.li3': 'Redesign a migrácia existujúcich webov',
      'skills.col2.li4': 'Základy SEO — aby vás Google našiel',
      'skills.col2.li5': 'Rýchlosť a optimalizácia obrázkov',
      'skills.col2.li6': 'Zálohovanie a obnova webu',

      'skills.col3.title': 'Aplikácie & Platformy',
      'skills.col3.li1': 'Komplexnejšie weby s databázou a registráciou',
      'skills.col3.li2': 'AI nástroje priamo na webe (prekladače, wizardy)',
      'skills.col3.li3': 'Adresáre, platformy, predplatné',
      'skills.col3.li4': 'Viacstupňové formuláre a rezervačné systémy',
      'skills.col3.li5': 'Dvojjazyčné weby (SK / EN)',

      'skills.col4.title': 'Brand & Print',
      'skills.col4.li1': 'Etikety a obaly (víno, jedlo, kozmetika)',
      'skills.col4.li2': 'Vizuálna identita — logo, farby, písmo',
      'skills.col4.li3': 'Akvarelové ilustrácie pre tlač aj web',
      'skills.col4.li4': 'Ľudové a prírodné motívy v modernom spracovaní',
      'skills.col4.li5': 'Príprava podkladov pre tlačiareň',
    ...
    en: {
      ...
      'hero.tagline': 'I build websites like art —<br>with intention, feeling, and detail.',
      ...
      'projects.callout.cta': 'Want a website like this?',
      ...
      'skills.col1.li6': 'Accessible to everyone — including users with disabilities',

      'skills.col2.title': 'WordPress & CMS',
      'skills.col2.li1': 'WordPress with Elementor — custom-built',
      'skills.col2.li2': 'Custom blocks and extra components',
      'skills.col2.li3': 'Redesign and migration of existing websites',
      'skills.col2.li4': 'Basic SEO — so Google can find you',
      'skills.col2.li5': 'Speed and image optimisation',
      'skills.col2.li6': 'Website backup and recovery',

      'skills.col3.title': 'Apps & Platforms',
      'skills.col3.li1': 'More complex websites with database and registration',
      'skills.col3.li2': 'AI tools directly on the website (translators, wizards)',
      'skills.col3.li3': 'Directories, platforms, subscriptions',
      'skills.col3.li4': 'Multi-step forms and booking systems',
      'skills.col3.li5': 'Bilingual websites (SK / EN)',

      'skills.col4.title': 'Brand & Print',
      'skills.col4.li1': 'Labels and packaging (wine, food, cosmetics)',
      'skills.col4.li2': 'Visual identity — logo, colours, typeface',
      'skills.col4.li3': 'Watercolour illustrations for print and web',
      'skills.col4.li4': 'Folk and natural motifs in a modern treatment',
      'skills.col4.li5': 'Print-ready files',
